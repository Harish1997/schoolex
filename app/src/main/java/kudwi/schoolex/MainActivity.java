...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.loadUrl("http://timesofindia.indiatimes.com/topic/school/news"); //try js alert
    ...
    public List<topdata> fill_with_datacbse() {
        ...
        data.add(new topdata("Padma Seshadri Bala Bhavan", R.drawable.hindu,"http://www.psbbmillenniumschool.org/psbbmillennium/App_Themes/PsbbMillennium/images/gbkm-school.jpg",(float)5));
        ...
        data.add(new topdata("National Public School,Chennai", R.drawable.hindu,"http://schoolconnects.s3.amazonaws.com/s3fs-public/dav.gif",(float)5));
        data.add(new topdata("D.A.V(Boys) Senior Secondary School", R.drawable.hindu,"http://cdn2.momjunction.com/wp-content/uploads/2016/03/16National-Public-School.jpg",(float)5));
